    ...
    try:
        ...
        if len(files) == 0:
            ...
            for file in files:
                ...
                mode_obj.writeText(file = file, text = location) #makes copy or overwrites based on overwrite CLI arg
    ...
    if T:
        main(\
            [
                ...
                #"--keywords", r'logger',
                #"--keywords",r"datetime",
                "--location", r"C:\\Users\\hduon\Documents\\API_Utilities\\test files",#__file__,
                "--mode", 'Replace',
                "--category", "Universal",
                #"--custom_regex",r".*",
                "--file_type", '.txt',
